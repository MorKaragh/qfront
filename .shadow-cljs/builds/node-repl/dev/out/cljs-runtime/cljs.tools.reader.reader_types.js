...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_16984 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_16984(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_16985 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_16985(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16987 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_16987(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16989 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_16989(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16991 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_16991(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16993 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_16993(reader);
}
});
...
var G__17060 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__17061 = s.append(c);
c = G__17060;
s = G__17061;
continue;
}
