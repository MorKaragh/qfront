...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_20863 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_20863(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_20866 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_20866(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_20867 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_20867(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_20870 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_20870(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_20873 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_20873(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_20875 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_20875(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_20878 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_20878(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_20880 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_20880(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_20881 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_20881(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_20885 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_20885(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_20894 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_20894(b);
}
});
