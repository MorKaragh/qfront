...
var o17878 = temp__5802__auto__;
var temp__5802__auto____$1 = (o17878["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o17879 = temp__5802__auto____$1;
return (o17879["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__13361__auto__ = f;
return (o__13361__auto__["toString"]).call(o__13361__auto__);
} else {
return "";
}
}catch (e17882){var _ = e17882;
return "";
}});
...
try{var o__13361__auto___18147 = t;
(o__13361__auto___18147["cljs$lang$ctorPrWriter"]).call(o__13361__auto___18147,t,writer);
}catch (e17901){var __18148 = e17901;
}
...
var char_code = (function (){var o__13361__auto__ = (new String(char$));
return (o__13361__auto__["charCodeAt"]).call(o__13361__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__13361__auto__ = String;
return (o__13361__auto__["fromCharCode"]).call(o__13361__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__17904 = num_code;
switch (G__17904) {
case (1):
return (185);
...
var o__13361__auto__ = String;
return (o__13361__auto__["fromCharCode"]).call(o__13361__auto__,superscript_code);
});
/**
...
}catch (e17927){var _e__13368__auto__ = e17927;
return false;
}})())){
...
var vec__17929 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17929,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__17946){
var vec__17947 = p__17946;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17947,(0),null);
...
var G__18175 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__18176 = cljs.core.butlast(remaining_tokens);
name_tokens = G__18175;
remaining_tokens = G__18176;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq17942){
var G__17943 = cljs.core.first(seq17942);
var seq17942__$1 = cljs.core.next(seq17942);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17943,seq17942__$1);
}));
...
var vec__17960 = cljs.core.split_with((function (p1__17958_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__17958_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17960,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17960,(1),null);
...
var vec__17966 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17966,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17966,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__18178 = cljs.core.rest(remaining_tokens);
var G__18179 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__18178;
name_tokens = G__18179;
continue;
} else {
...
var vec__17977 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17977,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17977,(1),null);
var vec__17980 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17980,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17980,(1),null);
var vec__17983 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17983,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17983,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17983,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17983,(3),null);
...
var vec__18000 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18000,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18000,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18000,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18000,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18000,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18000,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__18004 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18004,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18004,(1),null);
var vec__18007 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18007,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18007,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__18014 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__18014) : devtools.munging.parse_fn_info_deep.call(null,G__18014));
})()));
}
} else {
return fn_info;
...
var G__18187 = (arity + (1));
var G__18188 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__18019){
var vec__18020 = p__18019;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18020,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18020,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18030_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__18030_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18031_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__18031_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__18045){
var vec__18046 = p__18045;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18046,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq18040){
var G__18041 = cljs.core.first(seq18040);
var seq18040__$1 = cljs.core.next(seq18040);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18041,seq18040__$1);
}));
...
var map__18068 = options;
var map__18068__$1 = cljs.core.__destructure_map(map__18068);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18068__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18068__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18068__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18068__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__18069 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18069,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18069,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18069,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18069,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18069,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18069,(5),null);
...
var o__13361__auto__ = f;
return (o__13361__auto__["getBasis"]).call(o__13361__auto__);
});
/**
...
}catch (e18089){var _e__13368__auto__ = e18089;
...
var G__18204 = (obj[cljs.core.first(path)]);
var G__18205 = cljs.core.rest(path);
obj = G__18204;
path = G__18205;
continue;
} else {
...
var _STAR_ = (function (accum,p__18103){
var vec__18104 = p__18103;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18104,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18104,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__18109){
var vec__18112 = p__18109;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18112,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18112,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18112,(2),null);
...
var post_process = (function (p__18129){
var vec__18136 = p__18129;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18136,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18136,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18123_SHARP_){
return (obj[cljs.core.first(p1__18123_SHARP_)]);
}),sorted_matches);
