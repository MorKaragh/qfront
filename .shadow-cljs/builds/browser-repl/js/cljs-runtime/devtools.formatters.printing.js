...
var G__18336 = (i__5770__auto___18333 + (1));
i__5770__auto___18333 = G__18336;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq18213){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18214,G__18215,seq18213__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__18242_SHARP_){
return (!((cljs.core.meta(p1__18242_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18262__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e18264){var _e__13368__auto__ = e18264;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e18266){var _e__13368__auto__ = e18266;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__18276 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__18277 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__18277);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18302__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__18276);
}});
...
var temp__5802__auto___18369 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___18369)){
var managed_print_level_18372 = temp__5802__auto___18369;
var _STAR_print_level_STAR__orig_val__18309_18373 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__18310_18374 = managed_print_level_18372;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__18310_18374);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__18307_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__18307_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__18309_18373);
}} else {
job_fn();
}
