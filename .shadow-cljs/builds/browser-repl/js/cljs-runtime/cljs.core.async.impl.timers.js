...
var i_21126 = (self__.level + (1));
while(true){
if((i_21126 <= (new_level + (1)))){
(update[i_21126] = self__.header);

var G__21127 = (i_21126 + (1));
i_21126 = G__21127;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_21128 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_21128[i]));
} else {
x__$2.forward.push((((i < links_21128.length))?(links_21128[i]):null));
}

if((i < links_21128.length)){
(links_21128[i] = x__$2);
} else {
links_21128.push(x__$2);
}
...
var i_21130 = (0);
while(true){
if((i_21130 <= self__.level)){
var links_21131 = (update[i_21130]).forward;
if((x__$1 === (((i_21130 < links_21131.length))?(links_21131[i_21130]):null))){
(links_21131[i_21130] = (x__$1.forward[i_21130]));

var G__21132 = (i_21130 + (1));
i_21130 = G__21132;
continue;
} else {
var G__21133 = (i_21130 + (1));
i_21130 = G__21133;
continue;
}
} else {
...
var G__21135 = nx;
var G__21136 = (level__$1 - (1));
x = G__21135;
level__$1 = G__21136;
continue;
} else {
var G__21137 = x;
var G__21138 = (level__$1 - (1));
x = G__21137;
level__$1 = G__21138;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__21140 = nx;
var G__21141 = (level__$1 - (1));
x = G__21140;
level__$1 = G__21141;
continue;
} else {
var G__21142 = x;
var G__21143 = (level__$1 - (1));
x = G__21142;
level__$1 = G__21143;
continue;
}
